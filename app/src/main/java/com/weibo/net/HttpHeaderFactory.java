...
public abstract class HttpHeaderFactory {
    ...
    // 鐢熸垚鐢ㄤ簬鍝埚笇镄刡ase string涓诧紝娉ㄦ剰瑕佹寜椤哄簭锛屾寜闇€鏂囨。闇€姹傚弬鏁扮敓鎴愶紝鍚﹀垯40107阌栾
    ...
    // 瑙ｆ瀽url涓弬鏁板,瀛桦偍鍒皊ignatureBaseParams
