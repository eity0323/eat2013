...
public class Weibo {
    ...
    public static final String DEFAULT_REDIRECT_URI = "wbconnect://success";// 鏆备笉鏀寔
    public static final String DEFAULT_CANCEL_URI = "wbconnect://cancel";// 鏆备笉鏀寔
     ...
     * @throws com.weibo.net.WeiboException
     */
