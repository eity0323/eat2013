...
public class CartActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ListItemClickListener listlisten = new ListItemClickListener() {
					...
					builder.setNeutralButton("确认",new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							if(edit.getText().toString().equals("")){
								...
								add.delcart(EatParams.getInstance().list.get(position).getId());
							}
							else{
							add.modifyCarUrl(EatParams.getInstance().list.get(position).getId(),
