...
public class FoodAdapter extends BaseAdapter {
    ...
    public FoodAdapter(Activity context,List<FoodItem> mdata,Map<Integer, Boolean> map){
    	a = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.foodlist_item, null);
        ...
        holder.foodnumber.setText("销量："+(String)mList.get(position).getLKNUM());
