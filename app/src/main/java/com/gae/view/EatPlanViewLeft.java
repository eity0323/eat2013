...
public class EatPlanViewLeft extends RelativeLayout implements ViewBaseAction{
	...
	public EatPlanViewLeft(Context context) {
		super(context);
		init(context);
	}

	public EatPlanViewLeft(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public EatPlanViewLeft(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
