	...
	*/
	public void setValue(ArrayList<String> textArray, ArrayList<View> viewArray) {
		...
		for (int i = 0; i < viewArray.size(); i++) {
			...
			int maxHeight = (int) (displayHeight * 0.65);
			RelativeLayout.LayoutParams rl = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, maxHeight);
			rl.leftMargin = 10;
			rl.rightMargin = 10;
			...
			line.setBackgroundResource(R.drawable.divideline);
